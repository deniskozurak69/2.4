...
namespace LibraryApiWebApp.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        public MoviesController(LibrariAPIContext context)
        {
            _context = context;
        }
        ...
        {
            var movie = await _context.Movies.Include(c => c.Tickets).FirstOrDefaultAsync(c => c.Id == id);
        ...
        public async Task<ActionResult<Movie>> PostMovie(Movie movie)
        {
            ...
            var jsonMovie = JsonSerializer.Serialize(movie, options);
        ...
        public async Task<IActionResult> DeleteMovie(int id)
        {
            ...
            var ticketsToDelete = _context.Tickets.Where(a => a.MovieId == id);
